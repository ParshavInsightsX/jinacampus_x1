...
const navigationIconsByHref: Record<string, LucideIcon> = {
  ...
  "/schoolcast": Megaphone,
  "/schoolcast/notices": Bell,
  "/schoolcast/broadcasts": Send,
  "/schoolcast/approvals": ShieldCheck,
  "/schoolcast/homework": BookOpenCheck,
  "/schoolcast/delivery": Mail,
  "/schoolcast/analytics": ScrollText,
  "/schoolcast/templates": ClipboardList,
  "/schoolcast/calendar": CalendarCheck2,
  "/schoolcast/settings": Settings,
  "/notifications": Bell,
