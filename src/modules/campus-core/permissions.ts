export const CAMPUS_CORE_PERMISSIONS = [
  ...
  "platform.audit.view",
  "platform.regulatory.authority.manage",
  "platform.regulatory.duplicate.resolve",
  ...
  "campuscore.institution.regulatory.verify",
  "campuscore.institution.regulatory.publish",
  "campuscore.institution.regulatory.withdraw_publication",
